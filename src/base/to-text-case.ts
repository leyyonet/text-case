...
import { CallParams, CallValue, CallValuePro } from '@leyyo/http-call';
...
export function ToTextCase(
    params: CallValue<CaseType>,
...
const deco = decoratorPool
    .newId<PipeStored<P>, PipeMetadata<P, E>, PipeParam>(ToTextCase)
    .fqn(FQN)
